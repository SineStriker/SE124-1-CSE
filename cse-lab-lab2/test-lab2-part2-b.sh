...
timeout -k 2s 10s $MRCOORDINATOR 9876 ../novels/*.txt > ../cod.log 2>&1 &
pid=$!
...
timeout -k 1s 4s $MRWORKER 9876 ./ > ../w1.log 2>&1 &
timeout -k 1s 4s $MRWORKER 9876 ./ > ../w2.log 2>&1 &
timeout -k 1s 4s $MRWORKER 9876 ./ > ../w3.log 2>&1 &
timeout -k 1s 4s $MRWORKER 9876 ./ > ../w4.log 2>&1 &
